...
class GalleryController extends Zend_Controller_Action
{
    ...
    public function indexAction()
    {
        ...
        $this->view->description='gallery-description';

        $this->view->keywords = array('g1','g2');
    }
    ...
    public function displayAction()
    {
        ...
        if ($input->isValid()) {
            ...
            if (count($gallery) == 1) {
                ...
                //$this->view->title = $translate->_($gallery[0]['galleryname']).' </br><center><h3>('. $translate->_('from Helena Osokina').')</h3></center>';
                $this->view->title = $gallery[0]['galleryname'];
                $this->view->description = $gallery[0]['description'];
                $this->view->keywords = $gallery[0]['meta'];
